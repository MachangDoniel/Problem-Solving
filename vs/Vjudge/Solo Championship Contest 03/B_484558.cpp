...
void solve() {
    ...
    int rem=n%16;
    if(div==10) cout<<'A';
    else if(div==11) cout<<'B';
    else if(div==12) cout<<'C';
    else if(div==13) cout<<'D';
    else if(div==14) cout<<'E';
    else if(div==15) cout<<'F';
    else cout<<div;
    if(rem==10) cout<<'A';
    else if(rem==11) cout<<'B';
    else if(rem==12) cout<<'C';
    else if(rem==13) cout<<'D';
    else if(rem==14) cout<<'E';
    else if(rem==15) cout<<'F';
    else cout<<rem;
}
