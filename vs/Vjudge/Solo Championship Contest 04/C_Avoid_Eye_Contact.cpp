...
int n,m;
vector<vector<char>>v(2005,vector<char>(2005));
...
int start(int start_x,int start_y){
    visited[start_x][start_y]=true;
    priority_queue<pair<int,pair<int,int>>>pq;    // distance,co-ordinate
